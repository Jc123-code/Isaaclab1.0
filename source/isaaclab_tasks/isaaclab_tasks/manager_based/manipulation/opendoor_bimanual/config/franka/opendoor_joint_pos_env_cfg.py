...
from isaaclab_tasks.manager_based.manipulation.opendoor_bimanual import mdp
from isaaclab_tasks.manager_based.manipulation.opendoor_bimanual.mdp import franka_opendoor_events
from isaaclab_tasks.manager_based.manipulation.opendoor_bimanual.opendoor_env_cfg import OpenDoorEnvCfg
...
class EventCfg:
    ...
    init_franka_arm_pose = EventTerm(
        func=franka_opendoor_events.set_default_joint_pose,
        mode="startup",
        params={
    ...
    reset_table_joint_pose = EventTerm(
        func=franka_opendoor_events.reset_to_default_joint_pose,
        mode="reset",
        params={
            "default_pose": None,
            "asset_cfg": [SceneEntityCfg("table")],
    ...
    randomize_franka_joint_state = EventTerm(
        func=franka_opendoor_events.randomize_joint_by_gaussian_offset,
        mode="reset",
        params={
            "mean": 0.0,
            "std": 0.02,
...
@configclass
class FrankaOpenDoorEnvCfg(OpenDoorEnvCfg):
