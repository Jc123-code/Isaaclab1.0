...
from isaaclab_tasks.manager_based.manipulation.twistbottle import mdp
from isaaclab_tasks.manager_based.manipulation.twistbottle.mdp import franka_twistbottle_events
from isaaclab_tasks.manager_based.manipulation.twistbottle.twistbottle_env_cfg import TwistBottleEnvCfg
...
class EventCfg:
    ...
    init_franka_arm_pose = EventTerm(
        func=franka_twistbottle_events.set_default_joint_pose,
        mode="startup",
        params={
    ...
    reset_table_joint_pose = EventTerm(
        func=franka_twistbottle_events.reset_to_default_joint_pose,
        mode="reset",
        params={
            "default_pose": None,
            "asset_cfg": [SceneEntityCfg("table")],
    ...
    randomize_franka_joint_state = EventTerm(
        func=franka_twistbottle_events.randomize_joint_by_gaussian_offset,
        mode="reset",
        params={
            "mean": 0.0,
            "std": 0.02,
    ...
    reset_bottle_pose = EventTerm(
        func=franka_twistbottle_events.reset_bottle_pose_to_default,
        mode="reset",
        params={
            "default_pose": torch.tensor([
                # 0.8, 0.2, 1.5, 0.70711, 0.70711, 0, 0,  # 位置 + 四元数,0.3, 0.0, 0.75, 0, 0, 0, 1；-0.5, -0.5, 0.5, 0.5
                0.45, 0, 1.2, 0.70711, 0.70711, 0, 0,
...
@configclass
class FrankaTwistBottleEnvCfg(TwistBottleEnvCfg):
