...
def reset_bottle_pose_to_default(env, env_ids, default_pose, asset_cfg):
    """Reset the bottle rigid object to its default pose and zero velocity."""
    # 获取目标物体（书本）资产
    ...
    print(f"[Reset] Bottle pose reset for env_ids={env_ids.tolist()} to default pose.")
