...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    dustpan = RigidObjectCfg(
        prim_path="{ENV_REGEX_NS}/Table/dustpan",
    ...
    broom = RigidObjectCfg(
        prim_path="{ENV_REGEX_NS}/Table/broom",
        init_state=RigidObjectCfg.InitialStateCfg(
            pos=(-0.6, 0.0, 2.09),
            rot=(0.5, 0.5, 0.5, 0.5)
        ),
    ...
    paperball = RigidObjectCfg(
        prim_path="{ENV_REGEX_NS}/Table/paperball",
        init_state=RigidObjectCfg.InitialStateCfg(
            pos=(0, 0.0, 2.5),
            rot=(0, 0, 0, 0)
        ),
        spawn=sim_utils.UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/mine_assets/cleantable/PaperBall2.usdz",
            scale=(1.0, 1.0, 1.0),
            rigid_props=sim_utils.RigidBodyPropertiesCfg(
                disable_gravity=False,
                kinematic_enabled=False,
    ...
    # bananapeel = RigidObjectCfg(
    #     prim_path="{ENV_REGEX_NS}/Table/banana_peel",
    #     init_state=RigidObjectCfg.InitialStateCfg(
    #         pos=(0, -0.2, 2.5),
    #         rot=(0.70711, 0.70711, 0, 0)
    #     ),
    #     spawn=sim_utils.UsdFileCfg(
    #         usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/mine_assets/cleantable/Banana_Peel1.usdz",
    ...
    paperball = AssetBaseCfg(
        ...
        spawn=UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/mine_assets/PaperBall2.usdz",
            scale=(1.0, 1.0, 1.0),
            # visual_material=sim_utils.PreviewSurfaceCfg(  # ✅ 关键点
            #     diffuse_color=(1.0, 1.0, 0.0),  # 蓝色
            #     metallic=0.1,
            #     roughness=0.4
            # ),
        ),
    ...
    bananapeel = AssetBaseCfg(
        ...
        spawn=UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/mine_assets/Banana_Peel1.usdz",
            scale=(0.0003, 0.0003, 0.0003),
            # visual_material=sim_utils.PreviewSurfaceCfg(  # ✅ 关键点
            #     diffuse_color=(1.0, 1.0, 0.0),  # 蓝色
            #     metallic=0.1,
    ...
    table_frame = FrameTransformerCfg(
        ...
        target_frames=[
            FrameTransformerCfg.FrameCfg(
                # paperball 作为第一个目标frame (index 0)
                prim_path="{ENV_REGEX_NS}/Table/paperball",
                name="paperball",
                offset=OffsetCfg(
                    pos=(0.0, 0, 0),
...
class TerminationsCfg:
    ...
    success = DoneTerm(func=mdp.table_clean)


@configclass
class CleanTableEnvCfg(ManagerBasedRLEnvCfg):
