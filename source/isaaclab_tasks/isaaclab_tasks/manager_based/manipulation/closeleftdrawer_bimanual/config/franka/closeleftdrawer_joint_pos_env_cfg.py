...
from isaaclab_tasks.manager_based.manipulation.closeleftdrawer_bimanual import mdp
from isaaclab_tasks.manager_based.manipulation.closeleftdrawer_bimanual.mdp import franka_closeleftdrawer_events
from isaaclab_tasks.manager_based.manipulation.closeleftdrawer_bimanual.closeleftdrawer_env_cfg import CloseLeftDrawerEnvCfg
...
class EventCfg:
    ...
    init_franka_arm_pose = EventTerm(
        func=franka_closeleftdrawer_events.set_default_joint_pose,
        mode="startup",
        params={
    ...
    init_table_joint_pose = EventTerm(
        ...
        mode="startup",
        params={
            "default_pose": [[0.0 ,-0.25 ,0.0 ,0.0,0.0]],
            "asset_cfg": [SceneEntityCfg("table")],
        },
    )

    reset_table_joint_pose = EventTerm(
        func=franka_closeleftdrawer_events.reset_to_default_joint_pose,
        mode="reset",
        params={
            "default_pose": None,
            "asset_cfg": [SceneEntityCfg("table")],
    ...
    randomize_franka_joint_state = EventTerm(
        func=franka_closeleftdrawer_events.randomize_joint_by_gaussian_offset,
        mode="reset",
        params={
            "mean": 0.0,
            "std": 0.02,
...
@configclass
class FrankaCloseLeftDrawerEnvCfg(CloseLeftDrawerEnvCfg):
