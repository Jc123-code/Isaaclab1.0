    ...
    table_frame = FrameTransformerCfg(
        ...
        target_frames=[
            FrameTransformerCfg.FrameCfg(
                ...
                prim_path="{ENV_REGEX_NS}/Table/plate",
                name="grenade",
                offset=OffsetCfg(
                    pos=(0.0, 0, 0),
            ...
            FrameTransformerCfg.FrameCfg(
                # 手柄坐标系在哪里？它要固定附着在场景中已经存在的参考系，两者“相对位姿固定”
                prim_path="{ENV_REGEX_NS}/Table/plate_target",
                name="Box",
                offset=OffsetCfg(
                    pos=(0.0, 0, 0),
                    rot=(0, 0.0, 0.0, 0.0), # align with end-effector frame
...
class TerminationsCfg:
    ...
    success = DoneTerm(func=mdp.plate_success)


@configclass
class SetPlatesStackedEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the set_plates_stacked environment."""
