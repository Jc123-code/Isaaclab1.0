...
from isaaclab_tasks.manager_based.manipulation.openleftdrawer import mdp
from isaaclab_tasks.manager_based.manipulation.openleftdrawer.mdp import franka_openleftdrawer_events
from isaaclab_tasks.manager_based.manipulation.openleftdrawer.openleftdrawer_env_cfg import OpenLeftDrawerEnvCfg
...
class EventCfg:
    ...
    init_franka_arm_pose = EventTerm(
        func=franka_openleftdrawer_events.set_default_joint_pose,
        mode="startup",
        params={
    ...
    reset_table_joint_pose = EventTerm(
        func=franka_openleftdrawer_events.reset_to_default_joint_pose,
        mode="reset",
        params={
            "default_pose": None,
            "asset_cfg": [SceneEntityCfg("table")],
    ...
    randomize_franka_joint_state = EventTerm(
        func=franka_openleftdrawer_events.randomize_joint_by_gaussian_offset,
        mode="reset",
        params={
            "mean": 0.0,
            "std": 0.02,
...
@configclass
class FrankaOpenLeftDrawerEnvCfg(OpenLeftDrawerEnvCfg):
