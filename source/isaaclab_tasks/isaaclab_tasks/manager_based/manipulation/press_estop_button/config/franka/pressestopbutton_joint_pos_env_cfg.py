...
from isaaclab_tasks.manager_based.manipulation.press_estop_button import mdp
from isaaclab_tasks.manager_based.manipulation.press_estop_button.mdp import franka_pressestopbutton_events
from isaaclab_tasks.manager_based.manipulation.press_estop_button.pressestopbutton_env_cfg import PressEstopButtonEnvCfg
...
class EventCfg:
    ...
    init_franka_arm_pose = EventTerm(
        func=franka_pressestopbutton_events.set_default_joint_pose,
        mode="startup",
        params={
    ...
    reset_table_joint_pose = EventTerm(
        func=franka_pressestopbutton_events.reset_to_default_joint_pose,
        mode="reset",
        params={
            "default_pose": None,
            "asset_cfg": [SceneEntityCfg("table")],
    ...
    randomize_franka_joint_state = EventTerm(
        func=franka_pressestopbutton_events.randomize_joint_by_gaussian_offset,
        mode="reset",
        params={
            "mean": 0.0,
            "std": 0.02,
    ...
    reset_button_pose = EventTerm(
        func=franka_pressestopbutton_events.reset_pose_to_default,
        mode="reset",
        params={
...
@configclass
class FrankaPressEstopButtonEnvCfg(PressEstopButtonEnvCfg):
