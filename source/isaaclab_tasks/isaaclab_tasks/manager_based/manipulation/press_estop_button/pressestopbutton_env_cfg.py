...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    table = ArticulationCfg(
        ...
        init_state=ArticulationCfg.InitialStateCfg(
            ...
            joint_pos={
                ...
                # Keep within joint limits [-0.3, 0.0]
                "drawer_left_joint": -0.2,
    ...
    table_frame = FrameTransformerCfg(
        ...
        target_frames=[
            FrameTransformerCfg.FrameCfg(
                ...
                # Use the rigid body prim inside the button articulation (ButtonCap Xform).
                prim_path="{ENV_REGEX_NS}/button/Meshes/Cap/ButtonCap",
                name="grenade",
                offset=OffsetCfg(
                    pos=(0.0, 0, 0),
                    rot=(0, 0.0, 0.0, 0.0), # align with end-effector frame
                ),
            ),
            FrameTransformerCfg.FrameCfg(
                # 手柄坐标系在哪里？它要固定附着在场景中已经存在的参考系，两者“相对位姿固定”
    ...
    button = ArticulationCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/mine_assets/press_estop_button/Industrial_Button__4.usdz",
            scale=(1, 1, 1),
            # visual_material=sim_utils.PreviewSurfaceCfg(
        ...
        # Passive articulation: no actuators needed for button press.
        actuators={},
    )
...
class TerminationsCfg:
    ...
    success = DoneTerm(
        func=mdp.button_press_hold_success,
        params={
            "press_joint_name": "PrismaticJoint",
            "press_threshold": -0.025, #这里改按压深度阈值判断
            "hold_time_s": 2.0,
            "default_color": (0.5, 0.0, 1.0),
...
@configclass
class PressEstopButtonEnvCfg(ManagerBasedRLEnvCfg):
