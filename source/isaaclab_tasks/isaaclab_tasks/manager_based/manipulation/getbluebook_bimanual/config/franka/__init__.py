...
from . import (
    agents,
    getbluebook_ik_abs_env_cfg,
    getbluebook_joint_pos_env_cfg,
)
...
gym.register(
    id="Isaac-Get-BlueBook-Franka-Bimanual-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": getbluebook_joint_pos_env_cfg.FrankaGetBlueBookEnvCfg,
    },
...
gym.register(
    id="Isaac-Get-BlueBook-Franka-Bimanual-IK-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": getbluebook_ik_abs_env_cfg.FrankaGetBlueBookEnvCfg, # 环境入口
