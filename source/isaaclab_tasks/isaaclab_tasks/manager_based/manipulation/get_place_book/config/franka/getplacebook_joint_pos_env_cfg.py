...
from isaaclab_tasks.manager_based.manipulation.get_place_book import mdp
from isaaclab_tasks.manager_based.manipulation.get_place_book.mdp import franka_getplacebook_events
from isaaclab_tasks.manager_based.manipulation.get_place_book.getplacebook_env_cfg import GetPlaceBookEnvCfg
...
class EventCfg:
    ...
    init_franka_arm_pose = EventTerm(
        func=franka_getplacebook_events.set_default_joint_pose,
        mode="startup",
        params={
...
#重置逻辑
    ...
    reset_table_joint_pose = EventTerm(
        func=franka_getplacebook_events.reset_to_default_joint_pose,
        mode="reset",
        params={
            "default_pose": None,
            "asset_cfg": [SceneEntityCfg("table")],
    ...
    randomize_franka_joint_state = EventTerm(
        func=franka_getplacebook_events.randomize_joint_by_gaussian_offset,
        mode="reset",
        params={
            "mean": 0.0,
            "std": 0.02,
...
#目标物体：
    ...
    #     func=franka_getplacebook_events.reset_book_pose_to_default,
    #     mode="reset",
    #     params={
...
@configclass
class FrankaGetPlaceBookEnvCfg(GetPlaceBookEnvCfg):
