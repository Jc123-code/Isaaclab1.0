...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    table = ArticulationCfg(
        ...
        init_state=ArticulationCfg.InitialStateCfg(
            pos=(0, 0.0, 0), rot=(0.707, 0.0, 0.0, -0.707),
            joint_pos={
                "door_left_joint": 0.0,
    ...
    test = AssetBaseCfg(
        ...
        init_state=AssetBaseCfg.InitialStateCfg(pos=(-0.65, -0.017, 2.03841), rot=(0.60644,0.72492,-0.20136,-0.25725)),
        spawn=UsdFileCfg(usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/mine_assets/Rolled_towel1.usdz",
                         scale=(1.0, 1.0, 1.0)),
    )


    towel = RigidObjectCfg(
        prim_path="{ENV_REGEX_NS}/Table/towel",
        init_state=RigidObjectCfg.InitialStateCfg(
            pos=(0, 0, 2.03841),
            rot=(0.60644,0.72492,-0.20136,-0.25725)
        ),
        spawn=sim_utils.UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/mine_assets/Rolled_towel2.usdz",
            scale=(0.8, 0.8, 0.8),
...
@configclass
class WipeTableEnvCfg(ManagerBasedRLEnvCfg):
