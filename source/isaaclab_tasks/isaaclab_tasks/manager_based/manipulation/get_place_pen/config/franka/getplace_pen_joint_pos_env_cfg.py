...
from isaaclab_tasks.manager_based.manipulation.get_place_pen import mdp
from isaaclab_tasks.manager_based.manipulation.get_place_pen.mdp import franka_getplace_pen_events
from isaaclab_tasks.manager_based.manipulation.get_place_pen.getplace_pen_env_cfg import GetPlacePenEnvCfg
...
class EventCfg:
    ...
    init_franka_arm_pose = EventTerm(
        func=franka_getplace_pen_events.set_default_joint_pose,
        mode="startup",
        params={
    ...
    reset_table_joint_pose = EventTerm(
        func=franka_getplace_pen_events.reset_to_default_joint_pose,
        mode="reset",
        params={
            "default_pose": None,
            "asset_cfg": [SceneEntityCfg("table")],
    ...
    randomize_franka_joint_state = EventTerm(
        func=franka_getplace_pen_events.randomize_joint_by_gaussian_offset,
        mode="reset",
        params={
            "mean": 0.0,
            "std": 0.02,
    ...
    reset_pen_holder_pose = EventTerm(
        func=franka_getplace_pen_events.reset_pose_to_default,
        mode="reset",
        params={
            "default_pose": torch.tensor([
                0.45414, 0.3, 1.09, 0,0,-0.70711,-0.70711,   
                0, 0, 0, 0, 0, 0              # 静止
            ], device="cuda"),
    ...
    reset_pen_pose = EventTerm(
        func=franka_getplace_pen_events.reset_pose_to_default,
        mode="reset",
        params={
            "default_pose": torch.tensor([
                0.45414, 0.534, 1.0, 0.5, 0.5, -0.5, -0.5,   
                0, 0, 0, 0, 0, 0              # 静止
            ], device="cuda"),
...
@configclass
class FrankaGetPlacePenEnvCfg(GetPlacePenEnvCfg):
    ...
    def _marker_cfg(self, gelpad_prim: str) -> FOTSMarkerSimulatorCfg:
        return FOTSMarkerSimulatorCfg(
            ...
            frame_transformer_cfg=FrameTransformerCfg(
                ...
                target_frames=[
                    FrameTransformerCfg.FrameCfg(
                        prim_path="/World/envs/env_.*/Table/pen",
                        name="switch",
                    )
                ],
                debug_vis=False,
