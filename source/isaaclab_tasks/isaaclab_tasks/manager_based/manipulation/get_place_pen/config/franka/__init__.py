...
from . import (
    agents,
    getplace_pen_ik_abs_env_cfg,
    getplace_pen_joint_pos_env_cfg,
)
...
gym.register(
    id="Isaac-Get-place-Pen-Franka-Bimanual-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": getplace_pen_joint_pos_env_cfg.FrankaGetPlacePenEnvCfg,
    },
...
gym.register(
    id="Isaac-Get-place-Pen-Franka-Bimanual-IK-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": getplace_pen_ik_abs_env_cfg.FrankaGetPlacePenEnvCfg, # 环境入口
