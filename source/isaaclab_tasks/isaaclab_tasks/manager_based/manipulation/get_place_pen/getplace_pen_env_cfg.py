...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    pen_holder = RigidObjectCfg(
        prim_path="{ENV_REGEX_NS}/Table/pen_holder",
        init_state=RigidObjectCfg.InitialStateCfg(
            pos=(-0.12837, -0.559, 2.1591),
            rot=(0.5,0.5,-0.5,-0.5)
        ),
        spawn=sim_utils.UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/mine_assets/getpen/pen_holder.usdc",
    ...
    pen = RigidObjectCfg(
        prim_path="{ENV_REGEX_NS}/Table/pen",
        init_state=RigidObjectCfg.InitialStateCfg(
            pos=(-0.3193, -1.06425, 2.1565),
            rot=(0.5, 0.5, 0.5, 0.5)
        ),
        spawn=sim_utils.UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/mine_assets/getpen/pen.usdc",
            scale=(0.9,0.9, 1.0),
            rigid_props=sim_utils.RigidBodyPropertiesCfg(
                disable_gravity=False,
                kinematic_enabled=False,
    ...
    table_frame = FrameTransformerCfg(
        ...
        target_frames=[
            ...
            FrameTransformerCfg.FrameCfg(
                # pen_holder作为第二个目标frame (index 1)
                prim_path="{ENV_REGEX_NS}/Table/pen_holder",
                name="pen_holder",
                offset=OffsetCfg(
                    pos=(0, 0, -0.1),
...
class TerminationsCfg:
    ...
    success = DoneTerm(func=mdp.getplace_pen_success)


@configclass
class GetPlacePenEnvCfg(ManagerBasedRLEnvCfg):
