...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    table_frame = FrameTransformerCfg(
        ...
        prim_path="{ENV_REGEX_NS}/switch/Meshes/radio_base",
        debug_vis=False,
        target_frames=[
            FrameTransformerCfg.FrameCfg(
                # 开关手柄
                prim_path="{ENV_REGEX_NS}/switch/Meshes/radio_handle",
                name="handle",
                offset=OffsetCfg(
                    pos=(0.0, 0, 0),
                    rot=(0, 0.0, 0.0, 0.0),
    ...
    switch_base = RigidObjectCfg(
        prim_path="{ENV_REGEX_NS}/switch_base",
        init_state=RigidObjectCfg.InitialStateCfg(
            # 与 switch 同心放置，一个略高于桌面的底座，便于夹爪接近与操作
            pos=(0.7, -0.3, 1.27),
            rot=(1.0, 0.0, 0.0, 0.0),
        ),
    ...
    switch = ArticulationCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            ...
            # 以及可能的碰撞/刚体/关节信息。
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/mine_assets/twist_radio_on/Radio_blender.usdz",
...
class TerminationsCfg:
    ...
    success = DoneTerm(
        func=mdp.switch_joint_rotated_ccw_success,
        params={
            "angle_threshold_deg": 90,
            "hold_time_s": 0.1,
            "joint_name": None,
            "ccw_is_positive": False,
        },
    )


@configclass
class TwistRadioOnEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the twist_radio_on environment."""
