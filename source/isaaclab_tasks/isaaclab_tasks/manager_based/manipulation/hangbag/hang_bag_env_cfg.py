...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    table = ArticulationCfg(
        ...
        #     "handles": ImplicitActuatorCfg(
        #       joint_names_expr=["door_handle_joint"],
        #       effort_limit=50.0,
        #       velocity_limit=10.0,
        #       stiffness=5.0,
        #       damping=2.0,
    ...
    bag = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(
            pos=(0.48719, 0.43902, 1.02),
            rot=(0.03831, 0.03831, 0.70607, 0.70607)
        ),
        spawn=sim_utils.UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/mine_assets/hangbag/bag/bag.usdc",
            scale=(0.9,0.9, 0.9),
...
class TerminationsCfg:
    ...
    success = DoneTerm(
        func=mdp.get_bag_success,
        params={
            "target_pos": (0.64845, 0.52333, 1.1895),
            "success_radius": 0.06,
            "wait_time": 0.5,
        },
    )
...
@configclass
class HangBagEnvCfg(ManagerBasedRLEnvCfg):
