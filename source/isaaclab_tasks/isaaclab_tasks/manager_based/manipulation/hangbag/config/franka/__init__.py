...
from . import (
    agents,
    hang_bag_ik_abs_env_cfg,
    hang_bag_joint_pos_env_cfg,
)
...
gym.register(
    id="Isaac-Hang-Bag-Franka-Bimanual-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": hang_bag_joint_pos_env_cfg.FrankaHangBagEnvCfg,
    },
...
gym.register(
    id="Isaac-Hang-Bag-Franka-Bimanual-IK-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": hang_bag_ik_abs_env_cfg.FrankaHangBagEnvCfg, # 环境入口
