...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    stand = AssetBaseCfg(
        ...
        spawn=UsdFileCfg(usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/Stand/",
                         scale=(1.0, 1.0, 1.0)),
    )
...
class TerminationsCfg:
    ...
    success = DoneTerm(func=mdp.drawer_closed)


@configclass
class CloseDrawerEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the close drawer environment."""
