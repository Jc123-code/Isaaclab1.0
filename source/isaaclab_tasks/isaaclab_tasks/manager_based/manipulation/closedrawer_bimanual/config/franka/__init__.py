...
from . import (
    agents,
    closedrawer_ik_abs_env_cfg,
    closedrawer_joint_pos_env_cfg,
)
...
gym.register(
    id="Isaac-Close-Drawer-Franka-Bimanual-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": closedrawer_joint_pos_env_cfg.FrankaCloseDrawerEnvCfg,
    },
...
gym.register(
    id="Isaac-Close-Drawer-Franka-Bimanual-IK-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
