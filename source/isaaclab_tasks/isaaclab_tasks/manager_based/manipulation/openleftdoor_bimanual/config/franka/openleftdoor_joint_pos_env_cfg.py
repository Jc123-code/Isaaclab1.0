...
from isaaclab_tasks.manager_based.manipulation.openleftdoor_bimanual import mdp
from isaaclab_tasks.manager_based.manipulation.openleftdoor_bimanual.mdp import franka_openleftdoor_events
from isaaclab_tasks.manager_based.manipulation.openleftdoor_bimanual.openleftdoor_env_cfg import OpenLeftDoorEnvCfg
...
class EventCfg:
    ...
    init_franka_arm_pose = EventTerm(
        func=franka_openleftdoor_events.set_default_joint_pose,
        mode="startup",
        params={
    ...
    init_table_joint_pose = EventTerm(
        ...
        mode="startup",
        params={
            "default_pose": [[0.0 ,0.0 ,0.0 ,0.0,0]],
            "asset_cfg": [SceneEntityCfg("table")],
        },
    )

    reset_table_joint_pose = EventTerm(
        func=franka_openleftdoor_events.reset_to_default_joint_pose,
        mode="reset",
        params={
            "default_pose": None,
            "asset_cfg": [SceneEntityCfg("table")],
    ...
    randomize_franka_joint_state = EventTerm(
        func=franka_openleftdoor_events.randomize_joint_by_gaussian_offset,
        mode="reset",
        params={
            "mean": 0.0,
            "std": 0.02,
...
@configclass
class FrankaOpenLeftDoorEnvCfg(OpenLeftDoorEnvCfg):
