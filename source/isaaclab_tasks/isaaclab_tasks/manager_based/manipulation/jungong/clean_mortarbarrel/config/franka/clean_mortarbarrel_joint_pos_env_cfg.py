...
class EventCfg:
    ...
    weld_mortar_to_table = EventTerm(
        func=franka_clean_mortarbarrel_events.create_fixed_joint_between_assets,
        mode="startup",
        params={
            "parent_asset_cfg": SceneEntityCfg("table"),
            "child_asset_cfg": SceneEntityCfg("mortar"),
    ...
    init_franka_arm_pose = EventTerm(
        func=franka_clean_mortarbarrel_events.set_default_joint_pose,
        mode="startup",
        params={
    ...
    randomize_franka_joint_state = EventTerm(
        func=franka_clean_mortarbarrel_events.randomize_joint_by_gaussian_offset,
        mode="reset",
        params={
            "mean": 0.0,
            "std": 0.02,
...
@configclass
class FrankaCleanmortarbarrelEnvCfg(CleanmortarbarrelEnvCfg):
    ...
    def _marker_cfg(self, gelpad_prim: str) -> FOTSMarkerSimulatorCfg:
        return FOTSMarkerSimulatorCfg(
            ...
            frame_transformer_cfg=FrameTransformerCfg(
                ...
                target_frames=[
                    FrameTransformerCfg.FrameCfg(
                        prim_path="/World/envs/env_.*/mortar",
                        name="mortar",
                    )
                ],
                debug_vis=False,
