...
from . import clean_mortarbarrel_joint_pos_env_cfg
...
@configclass
class FrankaCleanmortarbarrelEnvCfg(clean_mortarbarrel_joint_pos_env_cfg.FrankaCleanmortarbarrelEnvCfg):
