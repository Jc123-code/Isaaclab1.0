...
from isaaclab_tasks.manager_based.manipulation.jungong.sorting_bullets import mdp
from isaaclab_tasks.manager_based.manipulation.jungong.sorting_bullets.mdp import franka_sorting_bullets_events
from isaaclab_tasks.manager_based.manipulation.jungong.sorting_bullets.sorting_bullets_env_cfg import SortingBulletsEnvCfg
...
class EventCfg:
    ...
    #     func=franka_sorting_bullets_events.create_fixed_joint_between_assets,
    #     mode="startup",
    #     params={
    ...
    init_franka_arm_pose = EventTerm(
        func=franka_sorting_bullets_events.set_default_joint_pose,
        mode="startup",
        params={
    ...
    randomize_franka_joint_state = EventTerm(
        func=franka_sorting_bullets_events.randomize_joint_by_gaussian_offset,
        mode="reset",
        params={
            "mean": 0.0,
            "std": 0.02,
    ...
    reset_bullet_762_pose = EventTerm(
        func=franka_sorting_bullets_events.reset_pose_to_default,
        mode="reset",
        params={
            "default_pose": [
                torch.tensor([
                    0.41769, 0.5, 1.03902, 0.62295, 0.44857, -0.55794, -0.3153,
                    0, 0, 0, 0, 0, 0
                ], device="cuda"),
            ],
    ...
    reset_Ammunition_Box_pose = EventTerm(
        func=franka_sorting_bullets_events.reset_pose_to_default,
        mode="reset",
        params={
            "default_pose": [
...
@configclass
class FrankaSortingBulletsEnvCfg(SortingBulletsEnvCfg):
    ...
    def _marker_cfg(self, gelpad_prim: str) -> FOTSMarkerSimulatorCfg:
        return FOTSMarkerSimulatorCfg(
            ...
            frame_transformer_cfg=FrameTransformerCfg(
                ...
                target_frames=[
                    FrameTransformerCfg.FrameCfg(
                        prim_path="/World/envs/env_.*/Ammunition_Box",      
                        name="Ammunition_Box",
                    )
                ],
                debug_vis=False,
