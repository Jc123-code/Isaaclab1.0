...
from isaaclab_tasks.manager_based.manipulation.jungong.set_mode_off import mdp
from isaaclab_tasks.manager_based.manipulation.jungong.set_mode_off.mdp import franka_setmodeoff_events
from isaaclab_tasks.manager_based.manipulation.jungong.set_mode_off.setmodeoff_env_cfg import SetModeOffEnvCfg
...
class EventCfg:
    ...
    init_franka_arm_pose = EventTerm(
        func=franka_setmodeoff_events.set_default_joint_pose,
        mode="startup",
        params={
    ...
    reset_table_joint_pose = EventTerm(
        func=franka_setmodeoff_events.reset_to_default_joint_pose,
        mode="reset",
        params={
            "default_pose": None,
            "asset_cfg": [SceneEntityCfg("table")],
    ...
    randomize_franka_joint_state = EventTerm(
        func=franka_setmodeoff_events.randomize_joint_by_gaussian_offset,
        mode="reset",
        params={
            "mean": 0.0,
            "std": 0.02,
    ...
    reset_switch_pose = EventTerm(
        func=franka_setmodeoff_events.reset_switch_pose_with_randomized_y,
        mode="reset",
        params={
            "y_values": (-0.3, 0.3),
            "default_pose": None,
...
@configclass
class FrankaSetModeOffEnvCfg(SetModeOffEnvCfg):
    ...
    def _marker_cfg(self, gelpad_prim: str) -> FOTSMarkerSimulatorCfg:
        return FOTSMarkerSimulatorCfg(
            ...
            frame_transformer_cfg=FrameTransformerCfg(
                ...
                target_frames=[
                    FrameTransformerCfg.FrameCfg(
                        prim_path="/World/envs/env_.*/switch/Meshes/handle",
                        name="switch",
                    )
                ],
                debug_vis=False,
