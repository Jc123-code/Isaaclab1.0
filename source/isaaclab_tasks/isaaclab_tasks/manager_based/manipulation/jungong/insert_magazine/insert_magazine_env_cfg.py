...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    tactical_vest = RigidObjectCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/mine_assets/jungong/insert_magazine/tactical_vest/tactical_vest.usdc",
    ...
    magazine = RigidObjectCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/mine_assets/jungong/insert_magazine/magazine/magazine.usdc",
            scale=(1, 1, 1),
            rigid_props=sim_utils.RigidBodyPropertiesCfg(
                disable_gravity=False,
                kinematic_enabled=False,
...
class TerminationsCfg:
    ...
    success = DoneTerm(func=mdp.insert_magazine_success)


@configclass
class InsertmagazineEnvCfg(ManagerBasedRLEnvCfg):
