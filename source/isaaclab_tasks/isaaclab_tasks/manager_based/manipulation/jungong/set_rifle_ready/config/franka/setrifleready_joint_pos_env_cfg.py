...
from isaaclab_tasks.manager_based.manipulation.jungong.set_rifle_ready import mdp
from isaaclab_tasks.manager_based.manipulation.jungong.set_rifle_ready.mdp import franka_setrifleready_events
from isaaclab_tasks.manager_based.manipulation.jungong.set_rifle_ready.setrifleready_env_cfg import (
    SetRiffleReadyEnvCfg,
)
...
class EventCfg:
    ...
    init_franka_arm_pose = EventTerm(
        func=franka_setrifleready_events.set_default_joint_pose,
        mode="startup",
        params={
    ...
    reset_table_joint_pose = EventTerm(
        func=franka_setrifleready_events.reset_to_default_joint_pose,
        mode="reset",
        params={
            "default_pose": None,
            "asset_cfg": [SceneEntityCfg("table")],
    ...
    randomize_franka_joint_state = EventTerm(
        func=franka_setrifleready_events.randomize_joint_by_gaussian_offset,
        mode="reset",
        params={
            "mean": 0.0,
            "std": 0.02,
...
@configclass
class FrankaSetRiffleReadyEnvCfg(SetRiffleReadyEnvCfg):
    ...
    def _marker_cfg(self, gelpad_prim: str) -> FOTSMarkerSimulatorCfg:
        return FOTSMarkerSimulatorCfg(
            ...
            frame_transformer_cfg=FrameTransformerCfg(
                ...
                target_frames=[
                    FrameTransformerCfg.FrameCfg(
                        prim_path="/World/envs/env_.*/switch/scene/Meshes/gun_handle",
                        name="gun_handle",
                    )
                ],
                debug_vis=False,
