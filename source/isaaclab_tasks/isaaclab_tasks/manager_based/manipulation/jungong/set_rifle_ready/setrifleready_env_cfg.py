...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    table_frame = FrameTransformerCfg(
        # 以 gun_base 作为 source frame
        prim_path="{ENV_REGEX_NS}/switch/scene/Meshes/gun_base",
        debug_vis=False,
        target_frames=[
            FrameTransformerCfg.FrameCfg(
                # 枪机拉柄
                prim_path="{ENV_REGEX_NS}/switch/scene/Meshes/gun_handle",
                name="gun_handle",
                offset=OffsetCfg(
                    pos=(0.0, 0, 0),
                    rot=(0, 0.0, 0.0, 0.0),
    ...
    switch = ArticulationCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            ...
            # 以及可能的碰撞/刚体/关节信息。
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/mine_assets/jungong/set_rifle_ready/new_6.usdz",
...
class TerminationsCfg:
    ...
    success = DoneTerm(
        func=mdp.gun_handle_pulled_success,
        params={
            "press_joint_name": "PrismaticJoint",
            "pull_threshold": 0.05,
            "pull_direction": "absolute",
            "hold_time_s": 0.0,
        },
    )
...
@configclass
class SetRiffleReadyEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the set_riffle_ready environment."""
