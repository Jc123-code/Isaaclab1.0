...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    button = ArticulationCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/mine_assets/jungong/mission_abort_estop/Industrial_Button.usdz",
            scale=(1, 1, 1),
            # visual_material=sim_utils.PreviewSurfaceCfg(
...
@configclass
class MissionAbortEstopEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the mission_abort_estop environment."""
