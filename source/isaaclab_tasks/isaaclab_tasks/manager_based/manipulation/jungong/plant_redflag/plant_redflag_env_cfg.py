...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    sandbox = RigidObjectCfg(
        prim_path="{ENV_REGEX_NS}/sandbox",
        init_state=RigidObjectCfg.InitialStateCfg(
            pos=(0.61, -0.16692, 1.03168),
            rot=(0.70651, 0.70769, 0.00172, 0.00402)
        ),
        spawn=sim_utils.UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/mine_assets/jungong/plant_redflag/sandbox/sandbox.usdc",
    ...
    redflag = RigidObjectCfg(
        prim_path="{ENV_REGEX_NS}/redflag",
        init_state=RigidObjectCfg.InitialStateCfg(
            pos=(0.54085, -0.50117, 1.03),
            rot=(0.65683, 0.65591, 0.26176, 0.26427)
        ),
        spawn=sim_utils.UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/mine_assets/jungong/plant_redflag/redflag/redflag.usdc",
            scale=(1, 1, 1),
            rigid_props=sim_utils.RigidBodyPropertiesCfg(
                disable_gravity=False,
                kinematic_enabled=False,
...
class TerminationsCfg:
    ...
    success = DoneTerm(func=mdp.plant_redflag_success)


@configclass
class PlantredflagEnvCfg(ManagerBasedRLEnvCfg):
