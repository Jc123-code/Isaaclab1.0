...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    table_frame = FrameTransformerCfg(
        # 以 cylinder 作为 source frame
        prim_path="{ENV_REGEX_NS}/switch/Meshes/cylinder",
        debug_vis=False,
        target_frames=[
            FrameTransformerCfg.FrameCfg(
                # 开关手柄
                prim_path="{ENV_REGEX_NS}/switch/Meshes/valve",
                name="handle",
                offset=OffsetCfg(
                    pos=(0.0, 0, 0),
                    rot=(0, 0.0, 0.0, 0.0),
...
@configclass
class UnlockCylinderValveEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the unlock_cylinder_valve environment."""
