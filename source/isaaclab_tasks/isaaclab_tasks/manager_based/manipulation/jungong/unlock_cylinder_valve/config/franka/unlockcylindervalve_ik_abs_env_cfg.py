...
from . import unlockcylindervalve_joint_pos_env_cfg
...
@configclass
class FrankaUnlockCylinderValveEnvCfg(
    unlockcylindervalve_joint_pos_env_cfg.FrankaUnlockCylinderValveEnvCfg
):
