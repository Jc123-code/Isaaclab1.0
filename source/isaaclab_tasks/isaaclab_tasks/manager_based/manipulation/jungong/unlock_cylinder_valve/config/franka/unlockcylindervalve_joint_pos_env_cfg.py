...
from isaaclab_tasks.manager_based.manipulation.jungong.unlock_cylinder_valve import mdp
from isaaclab_tasks.manager_based.manipulation.jungong.unlock_cylinder_valve.mdp import franka_unlockcylindervalve_events
from isaaclab_tasks.manager_based.manipulation.jungong.unlock_cylinder_valve.unlockcylindervalve_env_cfg import (
    UnlockCylinderValveEnvCfg,
)
...
class EventCfg:
    ...
    init_franka_arm_pose = EventTerm(
        func=franka_unlockcylindervalve_events.set_default_joint_pose,
        mode="startup",
        params={
    ...
    reset_table_joint_pose = EventTerm(
        func=franka_unlockcylindervalve_events.reset_to_default_joint_pose,
        mode="reset",
        params={
            "default_pose": None,
            "asset_cfg": [SceneEntityCfg("table")],
    ...
    randomize_franka_joint_state = EventTerm(
        func=franka_unlockcylindervalve_events.randomize_joint_by_gaussian_offset,
        mode="reset",
        params={
            "mean": 0.0,
            "std": 0.02,
...
@configclass
class FrankaUnlockCylinderValveEnvCfg(UnlockCylinderValveEnvCfg):
    ...
    def _marker_cfg(self, gelpad_prim: str) -> FOTSMarkerSimulatorCfg:
        return FOTSMarkerSimulatorCfg(
            ...
            frame_transformer_cfg=FrameTransformerCfg(
                ...
                target_frames=[
                    FrameTransformerCfg.FrameCfg(
                        prim_path="/World/envs/env_.*/switch/Meshes/cylinder",
                        name="switch",
                    )
                ],
                debug_vis=False,
