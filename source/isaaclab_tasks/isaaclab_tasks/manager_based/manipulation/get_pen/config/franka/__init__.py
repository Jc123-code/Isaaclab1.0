...
from . import (
    agents,
    get_pen_ik_abs_env_cfg,
    get_pen_joint_pos_env_cfg,
)
...
gym.register(
    id="Isaac-Get-Pen-Franka-Bimanual-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": get_pen_joint_pos_env_cfg.FrankaGetPenEnvCfg,
    },
...
gym.register(
    id="Isaac-Get-Pen-Franka-Bimanual-IK-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": get_pen_ik_abs_env_cfg.FrankaGetPenEnvCfg, # 环境入口
