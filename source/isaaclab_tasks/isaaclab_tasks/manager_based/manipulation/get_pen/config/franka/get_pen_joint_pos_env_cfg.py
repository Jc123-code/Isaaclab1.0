...
from isaaclab_tasks.manager_based.manipulation.get_pen import mdp
from isaaclab_tasks.manager_based.manipulation.get_pen.mdp import franka_get_pen_events
from isaaclab_tasks.manager_based.manipulation.get_pen.getpen_env_cfg import GetPenEnvCfg
...
class EventCfg:
    ...
    init_franka_arm_pose = EventTerm(
        func=franka_get_pen_events.set_default_joint_pose,
        mode="startup",
        params={
    ...
    reset_table_joint_pose = EventTerm(
        func=franka_get_pen_events.reset_to_default_joint_pose,
        mode="reset",
        params={
            "default_pose": None,
            "asset_cfg": [SceneEntityCfg("table")],
    ...
    randomize_franka_joint_state = EventTerm(
        func=franka_get_pen_events.randomize_joint_by_gaussian_offset,
        mode="reset",
        params={
            "mean": 0.0,
            "std": 0.02,
    ...
    #     func=franka_get_pen_events.reset_pose_to_default,
    #     mode="reset",
    #     params={
    #         "default_pose": torch.tensor([
    #             0.45414, 0.3, 1.06, 0,0,-0.70711,-0.70711,   
    #             0, 0, 0, 0, 0, 0              # 静止
    #         ], device="cuda"),
...
@configclass
class FrankaGetPenEnvCfg(GetPenEnvCfg):
